...
export default function MySkills() {
  ...
  "/stacksicons/typescript.svg",
    ...
    return (
        <section className=" w-full mt-5 bg-section flex items-center flex-col  py-8 px-12 rounded-md relative mx-auto overflow-hidden">
            
            <h2 className="text-center text-highlight mb-5 text-2xl md:text-4xl"><TextAnimate animation="slideUp" by="word">Minhas Habilidades</TextAnimate></h2>
            <div className="flex flex-col md:grid md:grid-cols-2 items-strech gap-8 2xl:w-[70%] w-[90%]  rounded-md">
                <div className="flex justify-center items-center bg-neutral-950 p-2 md:p-5 border bg- rounded-md border-gray-700">
                    <IconCloud  images={stackIcons} />
                </div>
                <div className="space-y-5 border bg-neutral-950 border-gray-700 flex flex-col justify-center text-md text-gray-700 rounded-md">
